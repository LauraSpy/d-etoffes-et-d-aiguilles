...
<body>
    <div class="homepage">
        ...
        <section class="contentCrea" id="creation">
            <div class="contentCreaTitle">Découvrez mes créations</div>
            <div class="contentCreaCarousel">
                <div class="caroussel">
                    <div class="carouselContainer">
                        <button class="navButton arrowLeft" onclick="handlePrev()"></button>
                        <div class="carousel">
                            <div class="carouselTrack" id="carouselTrack"></div>
                        </div>
                        <button class="navButton arrowRight" onclick="handleNext()"></button>
                    </div>
                </div>
            </div>
        </section>
