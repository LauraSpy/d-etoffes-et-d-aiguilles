...
<body>
    <!-- Skip Links -->
    <a href="#mainContent" class="skipLink" tabindex="0">Passer au contenu principal</a>
    <a href="#navbar" class="skipLink" tabindex="0">Passer au menu de navigation</a>
    ...
    <div class="homepage">
        <header class="Header">
            <nav>
                <div class="Container">
                    ...
                    <button class="menuButton" aria-controls="navbar" aria-expanded="false" tabindex="0">
                        <span class="sr-only" style="display: none;">Open main menu</span>
                        <svg class="w-5 h-5" aria-hidden="true" role="presentation" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 17 14">
                    ...
                    <div class="Navbar" id="navbar">
                        <ul>
                            <li><a href="#services" class="navbarLink" tabindex="0">Mes Services</a></li>
                            <li><a href="#creation" class="navbarLink" tabindex="0">Portfolio</a></li>
                            <li><a href="#presentation" class="navbarLink" tabindex="0">Qui Suis-je</a></li>
                            <li><a href="#contact" class="navbarLink" tabindex="0">Contact</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
        ...
        <main id="mainContent">
            <section class="heroSection">
                <div class="heroBackground">
                    ...
                    <div class="scrollButton" role="button" aria-label="scroll down" tabindex="0">
                        Scroll Down
                        <div class="arrow"></div>
                    </div>
                </div>
            ...
            <section class="nextSection" id="services">
                <div class="content">
                    <div class="flexContainer">
                        ...
                        <div class="rightText">
                            <h2 class="servicesTitle">Mes Services & Tarifs</h2>
                            <p class="serviceDetails">Création, Location, Retouches</p>
                        </div>
                    </div>
                    <!-- three boxes where the service are explained -->
                    <div class="case">
                        <div class="caseBox">
                            ...
                            <div class="caseBoxContent">
                                ...
                                <p>Remplir le <a href="https://forms.gle/bDAoJVdgKuMHEc1EA" class="download" target="_blank"
                                        rel="noopener noreferrer" title="cliquer pour aller sur le formulaire" aria-label="lien vers un formulaire googleform">formulaire</a> avec votre contact et le brouillon de votre
                        ...
                        <div class="caseBox">
                            ...
                            <div class="caseBoxContent">
                                ...
                                <p>Découvrez le catalogue disponible à la location pour vos événements et autres festivals !</p>
                        ...
                        <div class="caseBox">
                            ...
                            <div class="caseBoxContent">
                                ...
                                <a href="pdf/Listes_des_retouches.pdf" class="download" target="_blank"
                                    rel="noopener noreferrer" aria-label="télécharger le pdf de la liste des retouches">
                                    télécharger la grille des retouches</a>
                            </div>
                        </div>
                    </div>
            ...
            <section class="presentation" id="presentation">
                ...
                <div class="presentationBoxRight">
                    <h3 class="presentationBoxTitle">Qui Suis-je ?</h3>
                    ...
                    <div class="presentationBoxLogo">
                        <div class="logo">
                            <a href="https://www.instagram.com/d.etoffes_et_d.aiguilles/" title="visiter mon instagram" class="icon" aria-label="visiter la page instagram">
                                <svg fill="#3C2F2F" viewBox="0 0 17 17" height="1.5em" width="1.5em" role="presentation">
                                    <path
        ...
        <section class="contact" id="contact">
            ...
            <div>
                ...
                <div class="ContactLogo">
                    <div class="logo">
                        <a href="https://www.instagram.com/d.etoffes_et_d.aiguilles/" class="icon" title="visiter mon instagram" class="icon" aria-label="visiter la page instagram">
                            <svg fill="#F5F5DC" viewBox="0 0 17 17" height="1.5em" width="1.5em" role="presentation">
                                <path
                                    d="M8 0C5.829 0 5.556.01 4.703.048 3.85.088 3.269.222 2.76.42a3.917 3.917 0 00-1.417.923A3.927 3.927 0 00.42 2.76C.222 3.268.087 3.85.048 4.7.01 5.555 0 5.827 0 8.001c0 2.172.01 2.444.048 3.297.04.852.174 1.433.372 1.942.205.526.478.972.923 1.417.444.445.89.719 1.416.923.51.198 1.09.333 1.942.372C5.555 15.99 5.827 16 8 16s2.444-.01 3.298-.048c.851-.04 1.434-.174 1.943-.372a3.916 3.916 0 001.416-.923c.445-.445.718-.891.923-1.417.197-.509.332-1.09.372-1.942C15.99 10.445 16 10.173 16 8s-.01-2.445-.048-3.299c-.04-.851-.175-1.433-.372-1.941a3.926 3.926 0 00-.923-1.417A3.911 3.911 0 0013.24.42c-.51-.198-1.092-.333-1.943-.372C10.443.01 10.172 0 7.998 0h.003zm-.717 1.442h.718c2.136 0 2.389.007 3.232.046.78.035 1.204.166 1.486.275.373.145.64.319.92.599.28.28.453.546.598.92.11.281.24.705.275 1.485.039.843.047 1.096.047 3.231s-.008 2.389-.047 3.232c-.035.78-.166 1.203-.275 1.485a2.47 2.47 0 01-.599.919c-.28.28-.546.453-.92.598-.28.11-.704.24-1.485.276-.843.038-1.096.047-3.232.047s-2.39-.009-3.233-.047c-.78-.036-1.203-.166-1.485-.276a2.478 2.478 0 01-.92-.598 2.48 2.48 0 01-.6-.92c-.109-.281-.24-.705-.275-1.485-.038-.843-.046-1.096-.046-3.233 0-2.136.008-2.388.046-3.231.036-.78.166-1.204.276-1.486.145-.373.319-.64.599-.92.28-.28.546-.453.92-.598.282-.11.705-.24 1.485-.276.738-.034 1.024-.044 2.515-.045v.002zm4.988 1.328a.96.96 0 100 1.92.96.96 0 000-1.92zm-4.27 1.122a4.109 4.109 0 100 8.217 4.109 4.109 0 000-8.217zm0 1.441a2.667 2.667 0 110 5.334 2.667 2.667 0 010-5.334z" />
                            </svg>
                        </a>
            ...
            <div class="plusInfoCgu">
                <a href="./TermsOfServices/CGU.html" title="Pour plus d'informations sur les Conditions Générales d'Utilisation, cliquez ici" 
                aria-label="Pour plus d'informations sur les Conditions Générales d'Utilisation, cliquez ici">*
        ...
        <footer class="Footer">
            ...
            <div class="FooterContent">
                ...
                <div class="condition">
                    <a href="./TermsOfServices/CGU.html" title="Pour plus d'informations sur les Conditions Générales d'Utilisation, cliquez ici" 
                    aria-label="Pour plus d'informations sur les Conditions Générales d'Utilisation, cliquez ici">Conditions Générales d'Utilisation</a>
                    <a href="./TermsOfServices/MentionsLegales.html" title="Pour plus d'informations sur les mentions légales, cliquez ici" 
                    aria-label="Pour plus d'informations sur les Mentions Légales, cliquez ici">Mentions Légales</a>
                </div>
                <div class="Title">D'étoffes et d'Aiguilles</div>
                <div class="logo">
                    <a href="https://www.instagram.com/d.etoffes_et_d.aiguilles/" class="icon" title="visiter mon instagram" class="icon" aria-label="visiter la page instagram">
                        <svg fill="#3C2F2F" viewBox="0 0 17 17" height="2em" width="2em" role="presentation">
                            <path
                                d="M8 0C5.829 0 5.556.01 4.703.048 3.85.088 3.269.222 2.76.42a3.917 3.917 0 00-1.417.923A3.927 3.927 0 00.42 2.76C.222 3.268.087 3.85.048 4.7.01 5.555 0 5.827 0 8.001c0 2.172.01 2.444.048 3.297.04.852.174 1.433.372 1.942.205.526.478.972.923 1.417.444.445.89.719 1.416.923.51.198 1.09.333 1.942.372C5.555 15.99 5.827 16 8 16s2.444-.01 3.298-.048c.851-.04 1.434-.174 1.943-.372a3.916 3.916 0 001.416-.923c.445-.445.718-.891.923-1.417.197-.509.332-1.09.372-1.942C15.99 10.445 16 10.173 16 8s-.01-2.445-.048-3.299c-.04-.851-.175-1.433-.372-1.941a3.926 3.926 0 00-.923-1.417A3.911 3.911 0 0013.24.42c-.51-.198-1.092-.333-1.943-.372C10.443.01 10.172 0 7.998 0h.003zm-.717 1.442h.718c2.136 0 2.389.007 3.232.046.78.035 1.204.166 1.486.275.373.145.64.319.92.599.28.28.453.546.598.92.11.281.24.705.275 1.485.039.843.047 1.096.047 3.231s-.008 2.389-.047 3.232c-.035.78-.166 1.203-.275 1.485a2.47 2.47 0 01-.599.919c-.28.28-.546.453-.92.598-.28.11-.704.24-1.485.276-.843.038-1.096.047-3.232.047s-2.39-.009-3.233-.047c-.78-.036-1.203-.166-1.485-.276a2.478 2.478 0 01-.92-.598 2.48 2.48 0 01-.6-.92c-.109-.281-.24-.705-.275-1.485-.038-.843-.046-1.096-.046-3.233 0-2.136.008-2.388.046-3.231.036-.78.166-1.204.276-1.486.145-.373.319-.64.599-.92.28-.28.546-.453.92-.598.282-.11.705-.24 1.485-.276.738-.034 1.024-.044 2.515-.045v.002zm4.988 1.328a.96.96 0 100 1.92.96.96 0 000-1.92zm-4.27 1.122a4.109 4.109 0 100 8.217 4.109 4.109 0 000-8.217zm0 1.441a2.667 2.667 0 110 5.334 2.667 2.667 0 010-5.334z" />
                        </svg>
                    </a>
            ...
            <div class="Copyright">
                ©2024 | Site & Design par Krystiinals | Logo & Charte Graphique réalisé par <a href=""
                    style="text-decoration: underline; color: #F5F5DC;" aria-label="Lien vers la page instagram
                    de M.R. Design, graphiste des logo" role="button">M.R
    ...
    <div class="modal fade" id="cookieModal" tabindex="-1" aria-labelledby="cookieModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer la boîte de dialogue et refuser les cookies"></button>
            </div>
            <div class="modal-body">
                ...
                <p>Il utilise également ceux du service Elfsight Instagram Feed pour afficher du contenu Instagram sur notre site. </p>
                    ...
                    ce service, vous pouvez visiter nos <a href="./TermsOfServices/MentionsLegales.html" title="Pour plus d'informations sur les mentions légales, cliquez ici" 
                    aria-label="Pour plus d'informations sur les Mentions Légales, cliquez ici">Mentions Légales</a>, dans la rubrique "Cookies". </p>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" aria-label="Fermer la boîte de dialogue et refuser les cookies">Fermer</button>
                <button type="button" class="btn btn-primary" id="acceptCookies" aria-label="accepter les cookies">Accepter</button>
            </div>
            </div>
        </div>
    </div>
